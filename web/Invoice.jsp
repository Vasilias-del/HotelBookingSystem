<%-- 
    Document   : Invoice
    Created on : Dec 23, 2018, 11:12:33 AM
    Author     : FIQMANAN
--%>
...
<html>
    ...
    <body>
		...
		<!-- home wrapper -->
                <div class="home-wrapper" style="padding:30px;">
			<div class="container">
					<!-- home content -->
						...
						<div class="home-content" >
                                                    <div class="booking-form">
                                                        <h2>Hotel Hilton</h2>
                                                        <h5>Provide the luxury hotel to you</h5>
                                                        <h6>Address: 123 PO.BOX JALAN SEROJA INDAH,12345,KUALA LUMPUR.</h6>
                                                        <h6>No.Phone: 01232013021 </h6>
                                                        <hr>
                                                        
                                                        <h3 style="color: greenyellow">Your Booking Have Been Confirm</h3>
                                                        <ul>
                                                            <li>Booking ID: ${sessionScope.userbooking.getBookingID()}</li>
                                                            <li>Name: ${sessionScope.userbooking.getName()}</li>
                                                            <li>Username used:  ${sessionScope.userprofile.getUsername()}</li>
                                                            <li>Room Type : ${sessionScope.userbooking.getRoomtype()}</li>
                                                            <li>Amount of Adult :${sessionScope.userbooking.getAdult()}</li>
                                                            <li>Amount of Children: ${sessionScope.userbooking.getChildren()} </li>
                                                            <li style="font-size: 12px">Total Price: RM ${sessionScope.userbooking.getPrice()} </li>
                                                        </ul>
                                                        <hr>
                                                        <h4>Please bring this slip to the receptionist to get your hotel key<h4>
                                                                <h3> We would happy to serve you soon<h3>
                                                    </div>
						</div>
			</div>
		</div>

				...
				<div class="row">
					...
					<!-- /home content -->
						...
						<div class="booking-form">
                                                    <form method="post" action="UserEditBooking">
								<div class="form-group">
									...
									<input class="form-control" name="phone" id="phone" type="text" value="<%=phone%>" >
								</div>
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input class="form-control" name="checkin" id="checkin" type="text" value="<%=checkin%>" readonly>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-label">Check out</span>
											<input class="form-control" name="checkout" id="checkout" type="text" value="<%=checkout%>" readonly>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-4">
										<div class="form-group">
											...
											<input class="form-control" name="roomtype" id="roomtype" type="text" value="<%=room%>" readonly>	
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<span class="form-label">Adults</span>
											<input class="form-control" name="adult" id="adult" type="text" value="<%=adult%>" >
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<input class="form-control" name="children" id="children" type="text" value="<%=children%>" >
										</div>
									</div>
								</div>
                                                                 <input class="form-control" name="BookingID" id="BookingID" type="hidden" value="<%=BookingID%>" hidden>
								<div class="form-btn">

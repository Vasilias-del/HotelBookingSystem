<%-- 
    ...
    Created on : Dec 14, 2018, 10:46:01 AM
    Author     : FIQMANAN
--%>
...
<html>
	...
	<link type="text/css" rel="stylesheet" href="css/style.css" />
        ...
        <script>
            function message(){
                window.alert('You Are Already LogOut');
            }
        </script>
    </head>
    <body onload="message()">
			...
			<div class="container">
				...
				<ul class="main-nav nav navbar-nav navbar-right">
					...
					<li class="has-dropdown"><a href="#blog">User</a>
						<ul class="dropdown">
							<li><a href="index.jsp">Guess</a></li>
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h1 class="white-text">Hotel Hilton</h1>
                                                        <p>
                                                          <h2 class="white-text">You Have LogOut, Please LogIn Again to do Your Booking!</h2>  
                                                        <hr>
                                                        <button class="white-btn"><a href="index.jsp">Main Page</a></button>
                                                        <button class="white-btn"><a href="SignUp.jsp">Sign Up</a></button>
						</form>

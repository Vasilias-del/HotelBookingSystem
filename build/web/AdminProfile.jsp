       ...
       <header id="home">
		...
		<!-- home wrapper -->
                <section id="banner">
					...
					<hr>
                                        <center><img src ="./img/${sessionScope.memberprofile.getImage()}" width ="350" ></center>
                                                <form method="post" action="AdminUpdateProfile" style=" width: 100%;">
						<table style=" background:white; background-color:transparent; width:650px; height: 205px; margin:0 auto; color: #black;" >
							...
							<td><b><input type="text" name="password" id="password" value="${sessionScope.memberprofile.getPassword()}"/>
                                                        ...
                                                        <br>
                                                        <input type="hidden" name="image" id="image" value="${sessionScope.memberprofile.getImage()}"/>
